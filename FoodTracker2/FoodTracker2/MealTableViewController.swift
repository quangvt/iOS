...
//        let cell = tableView.dequeueReusableCell(withIdentifier: "reuseIdentifier", for: indexPath)
        // as? MealTableViewCell = downcast the returned obj from UITableViewCell to MealTableViewCell. This returns an optional
        //
    ...
    @IBAction func unwindToMealList(sender: UIStoryboardSegue) {
        if let sourceViewController = sender.source as? MealViewController, let meal = sourceViewController.meal {
            ...
            if let selectedIndexPath = tableView.indexPathForSelectedRow {
                ...
                // Add a new meal
                // compute the location in the table view
...
//    }
    ...
    private func loadMeals()
    {
        ...
        let url = URL(string:"http://localhost:3000/api/meal")
        ...
        { (data, response, error) in
            ...
            do
            {
                ...
                for index in 0..<myJson.count
                {
                    ...
                    if let checkedUrl = URL(string: "http://localhost:3000/public/photo/" + description!) {
